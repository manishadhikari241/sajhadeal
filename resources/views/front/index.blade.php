...
@section('content')
                 ...
                 @foreach($backgrounds as $back)
                    @if($back->status ==1 && $back->background==1)
                            <div class="slider-images relative owl-theme" style="max-height: 450px">
                                <a href="{{$back->link}}">
                                    <img src="{{  asset($back->logo) }}" alt="{{ $back->title }}" class="img-responsive" width="100%">
                                </a>
                            </div>
                    @endif
                @endforeach
    ...
    <section class="mb free-ads">
            <div class="container-fluid">
                <div class="row ">
                    <div class=""><a href="{{$advertisement->link}}"><img src="{{asset('images/advertisement/'.$advertisement->image)}}"  alt="" ></a></div>
                </div>
            </div>
        </section>
                    ...
                    <div class="rows">
                        <div class="latest-section our_product--tabs slick-slide owl-carousel">
                            ...
                            @foreach($featured as $product)
                                    ...
                                    <div class="card-body p-0">
                                        <figure><a href="{{route('view_details',$product->slug)}}">
                                                <img src="{{asset($product->get_main_image($product->id))}}" alt="{{$product->title}}">
                                            </a></figure>
                                    </div>
                                    <div class="card-footer">
                                        <div class="special-product_name">
