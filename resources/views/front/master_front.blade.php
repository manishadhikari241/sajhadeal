...
<head>
    ...
    <noscript><div><img src="https://mc.yandex.ru/watch/54533563" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
    <!-- /Yandex.Metrika counter -->
...
<div class="uk-offcanvas-content">
    ...
    <a href="tel:+977{{ isset($setting) ? $setting->company_number : '' }}"><div class="uk-margin-small-right show_in_mobile_device_only" uk-icon="receiver"></div></a>
    </-->
    <!-- back to top -->

        <a href="#" style="position:fixed;right:10px;z-index:9999;padding:10px;background:#6ebf45;bottom: 10px;color:#fff;" uk-totop uk-scroll  uk-tooltip="title: Back To Top; pos: left""></a>
</-->
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 ">
                    ...
                    <div class="footer_list">
                        <small><h1 class="text-muted">{!! isset($setting) ? strip_tags($setting->brief_about_us) : '' !!}</h1></small>
                    </div>
                    <div class="footer_list">
                        <ul>
                            <li class="footer_list--item1"><i
                                        class="icofont-map-pins icofont-2x"></i><a href="https://goo.gl/maps/D788cMM6xDjHBzbX9" target="_blank"> {{ isset($setting) ? $setting->address : ''}}</a></li>
                            <li class="footer_list--item1"><i
