            ...
            {{--<div class="row">--}}
                {{--<div class="col-md-12">--}}
                    ...
                    {{--<div class="owl-carousel owl-theme home-slider">--}}
                        {{--<div>--}}
                            {{--<a href="blog_single.blade.php" class="a-block d-flex align-items-center height-lg"--}}
                               {{--style="background-image: url('images/img_1.jpg'); ">--}}
                                {{--<div class="text half-to-full">--}}
                                    {{--<span class="category mb-5">Food</span>--}}
                                    {{--<div class="post-meta">--}}

                                        {{--<span class="author mr-2"><img src="{{asset('images/blogs/abc.jpg')}}"--}}
        ...
        <div class="container">
            ...
            <div class="row blog-entries">
                <div class="col-md-12 col-lg-8 main-content">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="{{route('blogs-single')}}" class="blog-entry" data-animate-effect="fadeIn">
