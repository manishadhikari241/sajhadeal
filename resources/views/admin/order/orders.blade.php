                        ...
                        @foreach($orders as $order)
                            <tr style="width:20px">
                                <td>
                                    ...
                                    <!--        data-target="#user_modal{{ $order->id }}">{{ $order->first_name }}</button>-->
                                    {{ $order->first_name }}
                                    <!--{{--user modal--}}-->
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <ul class="user-profile-list">
                                                        ...
                                                        <li><span>Name:&nbsp;</span>{{ $order->first_name }}</li>
                                ...
                                <td>
                                    ...
                                    @elseif($order->status == 0)
                                        <button class="btn btn-sm btn-outline-danger" data-toggle="modal"
                                                data-target="#cancel_order{{$order->id}}">Undo Cancel
                                        </button>
                                        <div class="modal fade" id="cancel_order{{$order->id}}" tabindex="-1"
                                             role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLongTitle">Change To Pending
                                                            !!</h5>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                                aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                    ...
                                                    <div class="modal-body">
                                                        Are you sure want to move this order to pending?
                                                    </div>
                                                    <div class="modal-footer">
                                                        <a href="{{ route('cancel_to_pending',$order->id) }}"
                                                           class="btn btn-primary">Yes</a>
                                                        <button type="button" class="btn btn-secondary"
                                                                data-dismiss="modal">No
                                                        </button>
